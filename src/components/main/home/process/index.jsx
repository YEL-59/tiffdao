...
const ProcessSection = () => {
  return (
    <section className="bg-[#f0f6fb] py-12 px-4 text-center">
      <p className="text-sm text-blue-600 font-medium">PROCESS</p>
        ...
        <div className="relative flex flex-col h-[345px] group">
          ...
          >
            <CardContent className="pt-20 flex flex-col flex-1 justify-end text-center">
              ...
              <Button className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-white text-blue-600 hover:bg-gray-100 self-center">
                Read More
              </Button>
            </CardContent>
          </Card>
